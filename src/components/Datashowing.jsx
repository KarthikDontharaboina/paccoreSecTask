...
//       {submittedData ? (
//         <>
//           <p><strong>Full Name:</strong> {submittedData.fullnameinput}</p>
//           <p><strong>Last Name:</strong> {submittedData.lastnameinput}</p>
//           <p><strong>Email:</strong> {submittedData.emailinput}</p>
//           <p><strong>Website:</strong> {submittedData.website}</p>
//           <p><strong>Country Code:</strong> {submittedData.cuntrycode}</p>
//           <p><strong>Phone Number:</strong> {submittedData.phonenumeber}</p>
//           <p><strong>How Can We Help:</strong> {submittedData.textarea}</p>
//         </>
//       ) : (
//         <div>
//           <h1>Teams data</h1>
//           <p><strong>teamSize:</strong> {teamData.teamSize}</p>
//           <p><strong>budget:</strong> {teamData.budget}</p>
//            {teamData.selectedServices.map(item => (
//             <p key={item} >
//               <strong>selectedService:</strong> {item}
//             </p>
//           ))}
